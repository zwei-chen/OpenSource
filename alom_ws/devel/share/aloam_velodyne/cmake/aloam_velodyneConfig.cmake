...
if(aloam_velodyne_CONFIG_INCLUDED)
  return()
endif()
set(aloam_velodyne_CONFIG_INCLUDED TRUE)

# set variables for source/devel/install prefixes
if("TRUE" STREQUAL "TRUE")
  set(aloam_velodyne_SOURCE_PREFIX /home/zwei/workspace/OpenSource/alom_ws/src/a-loam-noted)
  set(aloam_velodyne_DEVEL_PREFIX /home/zwei/workspace/OpenSource/alom_ws/devel)
  set(aloam_velodyne_INSTALL_PREFIX "")
  set(aloam_velodyne_PREFIX ${aloam_velodyne_DEVEL_PREFIX})
else()
  set(aloam_velodyne_SOURCE_PREFIX "")
  set(aloam_velodyne_DEVEL_PREFIX "")
  set(aloam_velodyne_INSTALL_PREFIX /home/zwei/workspace/OpenSource/alom_ws/install)
  set(aloam_velodyne_PREFIX ${aloam_velodyne_INSTALL_PREFIX})
endif()

# warn when using a deprecated package
if(NOT "" STREQUAL "")
  set(_msg "WARNING: package 'aloam_velodyne' is deprecated")
...
set(aloam_velodyne_FOUND_CATKIN_PROJECT TRUE)

if(NOT "/home/zwei/workspace/OpenSource/alom_ws/src/a-loam-noted/include;/usr/include/eigen3;/usr/include/pcl-1.10;/usr/include;/usr/include/vtk-7.1;/usr/include/freetype2;/usr/include/x86_64-linux-gnu;/usr/include/ni;/usr/include/openni2 " STREQUAL " ")
  set(aloam_velodyne_INCLUDE_DIRS "")
  set(_include_dirs "/home/zwei/workspace/OpenSource/alom_ws/src/a-loam-noted/include;/usr/include/eigen3;/usr/include/pcl-1.10;/usr/include;/usr/include/vtk-7.1;/usr/include/freetype2;/usr/include/x86_64-linux-gnu;/usr/include/ni;/usr/include/openni2")
  if(NOT " " STREQUAL " ")
    set(_report "Check the issue tracker '' and consider creating a ticket if the problem has not been reported yet.")
  elseif(NOT " " STREQUAL " ")
    set(_report "Check the website '' for information and consider reporting the problem.")
  else()
    set(_report "Report the problem to the maintainer 'qintong <qintonguav@gmail.com>' and request to fix the problem.")
  endif()
  foreach(idir ${_include_dirs})
    if(IS_ABSOLUTE ${idir} AND IS_DIRECTORY ${idir})
      set(include ${idir})
    elseif("${idir} " STREQUAL "include ")
      get_filename_component(include "${aloam_velodyne_DIR}/../../../include" ABSOLUTE)
      if(NOT IS_DIRECTORY ${include})
        message(FATAL_ERROR "Project 'aloam_velodyne' specifies '${idir}' as an include dir, which is not found.  It does not exist in '${include}'.  ${_report}")
      endif()
    else()
      message(FATAL_ERROR "Project 'aloam_velodyne' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/zwei/workspace/OpenSource/alom_ws/src/a-loam-noted/${idir}'.  ${_report}")
    endif()
    _list_append_unique(aloam_velodyne_INCLUDE_DIRS ${include})
  endforeach()
endif()
...
foreach(library ${libraries})
  ...
  if("${library}" MATCHES "^(debug|optimized|general)$")
    list(APPEND aloam_velodyne_LIBRARIES ${library})
  elseif(${library} MATCHES "^-l")
    list(APPEND aloam_velodyne_LIBRARIES ${library})
  elseif(${library} MATCHES "^-")
    # This is a linker flag/option (like -pthread)
    # There's no standard variable for these, so create an interface library to hold it
    if(NOT aloam_velodyne_NUM_DUMMY_TARGETS)
      set(aloam_velodyne_NUM_DUMMY_TARGETS 0)
    endif()
    # Make sure the target name is unique
    set(interface_target_name "catkin::aloam_velodyne::wrapped-linker-option${aloam_velodyne_NUM_DUMMY_TARGETS}")
    while(TARGET "${interface_target_name}")
      math(EXPR aloam_velodyne_NUM_DUMMY_TARGETS "${aloam_velodyne_NUM_DUMMY_TARGETS}+1")
      set(interface_target_name "catkin::aloam_velodyne::wrapped-linker-option${aloam_velodyne_NUM_DUMMY_TARGETS}")
    endwhile()
    ...
    list(APPEND aloam_velodyne_LIBRARIES "${interface_target_name}")
  ...
  elseif(IS_ABSOLUTE ${library})
    ...
    foreach(path /home/zwei/workspace/OpenSource/alom_ws/devel/lib;/opt/ros/noetic/lib)
    ...
    endforeach()
    if(lib)
      _list_append_unique(aloam_velodyne_LIBRARY_DIRS ${lib_path})
      list(APPEND aloam_velodyne_LIBRARIES ${lib})
    else()
      # as a fall back for non-catkin libraries try to search globally
      find_library(lib ${library})
      if(NOT lib)
        message(FATAL_ERROR "Project '${PROJECT_NAME}' tried to find library '${library}'.  The library is neither a target nor built/installed properly.  Did you compile project 'aloam_velodyne'?  Did you find_package() it before the subdirectory containing its code is included?")
      endif()
      list(APPEND aloam_velodyne_LIBRARIES ${lib})
    endif()
  endif()
...
set(aloam_velodyne_EXPORTED_TARGETS "")
# create dummy targets for exported code generation targets to make life of users easier
foreach(t ${aloam_velodyne_EXPORTED_TARGETS})
  if(NOT TARGET ${t})
    add_custom_target(${t})
  endif()
endforeach()
...
foreach(depend ${depends})
  ...
  list(GET depend_list 0 aloam_velodyne_dep)
  list(LENGTH depend_list count)
  if(${count} EQUAL 1)
    # simple dependencies must only be find_package()-ed once
    if(NOT ${aloam_velodyne_dep}_FOUND)
      find_package(${aloam_velodyne_dep} REQUIRED NO_MODULE)
    endif()
  else()
    # dependencies with components must be find_package()-ed again
    list(REMOVE_AT depend_list 0)
    find_package(${aloam_velodyne_dep} REQUIRED NO_MODULE ${depend_list})
  endif()
  _list_append_unique(aloam_velodyne_INCLUDE_DIRS ${${aloam_velodyne_dep}_INCLUDE_DIRS})

  # merge build configuration keywords with library names to correctly deduplicate
  _pack_libraries_with_build_configuration(aloam_velodyne_LIBRARIES ${aloam_velodyne_LIBRARIES})
  _pack_libraries_with_build_configuration(_libraries ${${aloam_velodyne_dep}_LIBRARIES})
  _list_append_deduplicate(aloam_velodyne_LIBRARIES ${_libraries})
  # undo build configuration keyword merging after deduplication
  _unpack_libraries_with_build_configuration(aloam_velodyne_LIBRARIES ${aloam_velodyne_LIBRARIES})

  _list_append_unique(aloam_velodyne_LIBRARY_DIRS ${${aloam_velodyne_dep}_LIBRARY_DIRS})
  _list_append_deduplicate(aloam_velodyne_EXPORTED_TARGETS ${${aloam_velodyne_dep}_EXPORTED_TARGETS})
endforeach()

set(pkg_cfg_extras "")
foreach(extra ${pkg_cfg_extras})
  if(NOT IS_ABSOLUTE ${extra})
    set(extra ${aloam_velodyne_DIR}/${extra})
  endif()
  include(${extra})
endforeach()
