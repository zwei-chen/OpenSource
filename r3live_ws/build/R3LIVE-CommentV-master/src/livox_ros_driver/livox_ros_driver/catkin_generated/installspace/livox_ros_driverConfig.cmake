...
if("FALSE" STREQUAL "TRUE")
  set(livox_ros_driver_SOURCE_PREFIX /home/zwei/workspace/OpenSource/r3live_ws/src/R3LIVE-CommentV-master/src/livox_ros_driver/livox_ros_driver)
...
if(NOT "include " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'livox_ros_driver' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '\${prefix}/${idir}'.  ${_report}")
    endif()
