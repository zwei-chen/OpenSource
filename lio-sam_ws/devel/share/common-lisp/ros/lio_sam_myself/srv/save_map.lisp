...
(cl:in-package lio_sam_myself-srv)
...
(cl:defmethod cl:initialize-instance :after ((m <save_map-request>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'save_map-request)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name lio_sam_myself-srv:<save_map-request> is deprecated: use lio_sam_myself-srv:save_map-request instead.")))

(cl:ensure-generic-function 'resolution-val :lambda-list '(m))
(cl:defmethod resolution-val ((m <save_map-request>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader lio_sam_myself-srv:resolution-val is deprecated.  Use lio_sam_myself-srv:resolution instead.")
  (resolution m))

(cl:ensure-generic-function 'destination-val :lambda-list '(m))
(cl:defmethod destination-val ((m <save_map-request>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader lio_sam_myself-srv:destination-val is deprecated.  Use lio_sam_myself-srv:destination instead.")
  (destination m))
...
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql '<save_map-request>)))
  ...
  "lio_sam_myself/save_mapRequest")
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql 'save_map-request)))
  "Returns string type for a service object of type 'save_map-request"
  "lio_sam_myself/save_mapRequest")
...
(cl:defmethod cl:initialize-instance :after ((m <save_map-response>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'save_map-response)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name lio_sam_myself-srv:<save_map-response> is deprecated: use lio_sam_myself-srv:save_map-response instead.")))

(cl:ensure-generic-function 'success-val :lambda-list '(m))
(cl:defmethod success-val ((m <save_map-response>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader lio_sam_myself-srv:success-val is deprecated.  Use lio_sam_myself-srv:success instead.")
  (success m))
...
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql '<save_map-response>)))
  ...
  "lio_sam_myself/save_mapResponse")
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql 'save_map-response)))
  "Returns string type for a service object of type 'save_map-response"
  "lio_sam_myself/save_mapResponse")
